...
using Tyuiu.AntonovNS.Sprint6.Task7.V9.Lib;
namespace Tyuiu.AntonovNS.Sprint6.Task7.V9
{
    public partial class FormMain : Form
    {
        ...
        string path = @"C:\Users\Пользователь\source\repos\Tyuiu.AntonovNS.Sprint6\Tyuiu.AntonovNS.Sprint6.Task5.V6\Sprint6Task5\InPutDataFileTask5V6.txt";
